...
const ProfileData = ({ data }: { data: string }) => {
    return (
        <div className="mb-3 text-md font-semibold text-gray-900">
            {data}
        </div>
    )
}
        ...
        <div className='min-h-screen w-full bg-gray-50'>
            <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4">
                <div className="mb-4 col-span-full xl:mb-2">
                    <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl">User Profile</h1>
                </div>
                <div className="col-span-full xl:col-auto">
                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
                        ...
                        <h3 className="mb-4 text-xl font-bold text-gray-900">{user_name}</h3>
                        <div className="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                    ...
                    <LoginTable demoUser={demoUser} />
                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
                        <div className="items-center">
                            <h3 className="mb-4 text-xl font-bold text-gray-900">User Labels</h3>
                            <div className=''>
                                {userBadges.map((badge, index) => {
                                    return (
                                        <span key={index} className="inline-flex items-center px-2 py-1 me-2 my-1 text-sm font-medium text-yellow-800 bg-yellow-100 rounded ">
                                            {badge.title}
                                            <button type="button" className="inline-flex items-center p-1 ms-2 text-sm text-yellow-400 bg-transparent rounded-sm hover:bg-yellow-200 hover:text-yellow-900" data-dismiss-target="#badge-dismiss-yellow" aria-label="Remove">
                                ...
                                <div className='flex gap-2 my-2'>
                                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Label" required />
                ...
                <div className="col-span-2">
                    ...
                    <RecentViewedProducts products={demoUser.recentlyViewedProducts} title='Recently Viewed Products' />
                    <RecentViewedProducts products={demoUser.wishlist ?? []} title='Wishlist Products' />
                </div>
            </div>
        </div>
    )
